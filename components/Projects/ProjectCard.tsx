...
import { 
    ProjectCardCon, ProjectCardImage, PercentComplete
...
function NavBar (
    ...
    return (
        <>
        <ProjectCardCon>
            <div style={{left: "50%", transform: "translateX(-50%)", position: "relative", background: "#00FCB9", width: "130px", height: "130px", borderRadius: "360px"}}>
                <ProjectCardImage
                    src={pfp}
                    height={130}
                    width={130}
